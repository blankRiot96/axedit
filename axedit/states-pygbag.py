...
class StateManager:
    def __init__(self) -> None:
        ...
        # self.songs = {
        #     State.MENU: "assets/audio/main-menu-bgm.ogg",
        #     State.TUTORIAL: "assets/audio/game-bgm.ogg",
        #     State.GAME: "assets/audio/game-bgm.ogg",
        #     State.GAME_OVER: "assets/audio/game-over-bgm.ogg",
        #     State.VICTORY: "assets/audio/victory-bgm.ogg",
        # }
